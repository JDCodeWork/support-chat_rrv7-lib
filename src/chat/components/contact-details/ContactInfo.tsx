...
export const ContactInfo = ({ customer }: Props) => {
  return (
    <div className="p-4">
      <div className="flex flex-col items-center pb-6 border-b">
        ...
        <p className="text-sm text-muted-foreground">{customer.currentPlan.toUpperCase()}</p>
        ...
        <div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span>{customer.currentPlan.toUpperCase()}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">Member since:</span>
              <span>{customer.memberSince.toLocaleDateString()}</span>
            </div>
            <div className="flex justify-between text-sm">
